...
function query() {
  ...
  // URL for querying
  var url= 'https://api.darksky.net/forecast/190486397513ebfd58710c8a5d3e96fa/42.361936, -71.097309';
...
function fourtysevenpast(data) {
	...
	var url= 'https://api.darksky.net/forecast/190486397513ebfd58710c8a5d3e96fa/42.361936, -71.097309, ' + pastTime.getTime()/1000;
...
// bottom graph
  ...
  text("0%",xGap-3,ycanvas-((1/4)*yBottomGap));
	...
	textAlign(RIGHT,TOP);
	rect(xGap+width-150,ycanvas-((1/4)*yBottomGap)+10,5,5)
	fill(0);
	text("Precipitation",xGap+width-70,ycanvas-((1/4)*yBottomGap)+5);
